...
INSERT INTO `pulse_tables` (`id`, `name`, `description`, `win_name`, `win_description`, `table_name_field`, `creationDate`) VALUES
(766, 'posts_pos', 'Blog Posts', 'Posts', 'Blog Posts', 'title', '".$dateTime."');
  
INSERT INTO `pulse_fields` (`table_id_fk`, `name`, `comment`, `win_name`, `win_description`, `win_order`, `win_type`, `win_code`, `creationDate`, `author`) VALUES
...
INSERT INTO `pulse_users` (`username`, `password`, `name`, `permissions`, `creationDate`, `activeDate`, `invokeType`, `lastInvoke`) VALUES
...
$pulseUpdate->execute();
$updateResult = $pulseUpdate->fetchAll(PDO::FETCH_ASSOC);
// Creation Status
($updateResult)? $tablesNot = "Ok" : $tablesNot = "Error: ".$pulseUpdate->errorInfo()[2];
...
$cssFile = fopen('Views/css/clean-blog.min.css', 'w');
...
$jsFile1 = fopen('Views/js/clean-blog.min.js', 'w');
...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?=basePath()?>/Pulse/Internal/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?=asset('clean-blog.min.css')?>" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?=basePath()?>/Pulse/Internal/css/font-awesome.min.css" rel="stylesheet" type="text/css">
