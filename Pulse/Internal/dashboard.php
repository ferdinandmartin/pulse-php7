...
<head>
    ...
    <link href="<?=basepath()?>/Pulse/Internal/codemirror/lib/codemirror.css" rel="stylesheet">
    ...
    <script src="<?=basepath()?>/Pulse/Internal/js/plugins/canvas-to-blob.min.js"></script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=path('adashboard')?>"><i class="fa fa-fw fa-heartbeat"></i> PULSE Framework</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?=$_SESSION['pulse.name']?> <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li<?php if(isActive()=='config'){ echo' class="active"'; } ?>>
                        <a href="<?=path('config')?>"><i class="fa fa-fw fa-desktop"></i> Configuration</a>
                    </li>
                </ul>
            </div>
            <?php
