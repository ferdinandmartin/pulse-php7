<?php if($ok!='ok'): ?>
        ...
        <p class="lead">
            Fill the fields to complete the configuration. If database does not exist Pulse tries to create it.
        </p>
        <section>
            <?php if($error!='no'): ?>
            ...
            <h2>Database connection</h2>
                <form id="formulario" role="form" method="post">
                        ...
                        <input type="text" class="form-control" id="password" name="password" placeholder="Database password">
                        </div>
...
<?php else: ?>
        ...
        <p class="lead">
            Please, <a href="<?=basePath()?>">visit home page of PULSE framework</a>.
        </p>
<?php endif; ?>
