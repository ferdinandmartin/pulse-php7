...
class Flash extends \Pulse\Kernel implements \ArrayAccess, \IteratorAggregate, \Countable
{
    /**
     * @var array
     */
    ...
    {
        $this->settings = array_merge(array('key' => 'pulse.flash'), $settings);
        $this->messages = array(
