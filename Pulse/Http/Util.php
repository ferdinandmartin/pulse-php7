...
class Util
{
     ...
     * @param  \Pulse\Http\Headers $headers The Response headers
     * @param  \Pulse\Http\Cookies $cookies The Response cookies
     * @param  array              $config  The Pulse app settings
     */
    public static function serializeCookies(\Pulse\Http\Headers &$headers, \Pulse\Http\Cookies $cookies, array $config)
    {
     ...
     *
     * This method will construct and set the HTTP `Set-Cookie` header. Pulse
     ...
     *
     * This method accepts the Pulse_Http_Headers object by reference as its
     ...
     * is already set in the HTTP response, it will also be removed. Pulse uses this method
