...
class View
{
    ...
    {
        $this->data = new \Pulse\Security\Set();
    }
    ...
    protected function render($template, $data = null)
    {
        ...
        if($templateEX[0]=='Pulse/Internal/Views' and $templateEX[1]!='configuration'){
            if($templateEX[1]=='login'){
                require 'Pulse/Internal/login.php';
            } else {
                require 'Pulse/Internal/dashboard.php';
            }
        } else {
